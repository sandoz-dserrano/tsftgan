...
class Discriminator(nn.Sequential):
    def __init__(self,
                 ...
                 **kwargs):
        super().__init__(
            PatchEmbeddingLinear(in_channels, patch_size, emb_size, seq_length),
            DiscriminatorTransformerEncoder(depth, emb_size=emb_size, drop_p=0.5, forward_drop_p=0.5, **kwargs),
